...
#define DEVICE_iOS_10    [UIDevice currentDevice].systemVersion.floatValue >= 10.0
 ...
 *   注册通知  
 */
+ (void)registerLocalNotification:(NSInteger)time title:(NSString *)title content:(NSString *)content;
{
        //创建一个本地通知
    ...
    // 通知参数
    NSDictionary *userDict = [NSDictionary dictionaryWithObject:content forKey:LOCALNOTIFICATION_KEY];
