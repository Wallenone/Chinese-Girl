...
- (void)loadImageNearIndex:(int)index
{
    if (index > 0) {
        ...
        [[SDWebImageManager sharedManager].imageDownloader downloadImageWithURL:photo.url options:SDWebImageLowPriority|SDWebImageRetryFailed progress:nil completed:^(UIImage * _Nullable image, NSData * _Nullable data, NSError * _Nullable error, BOOL finished) {
