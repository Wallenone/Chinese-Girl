...
- (instancetype)initWithFrame:(CGRect)frame withBuyBlock:(BuyGiftClickBlock)block withGetGift:(GetGiftBlock)giftBlock
{
    ...
    if (self) {
        ...
        giftNameArr=@[NSLocalizedString(@"Pound", nil),NSLocalizedString(@"Pumpkin", nil),NSLocalizedString(@"Mapleleaves", nil),NSLocalizedString(@"IphoneX", nil),NSLocalizedString(@"Hat", nil),NSLocalizedString(@"Crystalbar", nil),NSLocalizedString(@"Cake", nil),NSLocalizedString(@"glasses", nil),NSLocalizedString(@"Chilipatse", nil),NSLocalizedString(@"Pizza", nil),NSLocalizedString(@"Gamehandle", nil),NSLocalizedString(@"Chocolates", nil),NSLocalizedString(@"Pomegranate", nil),NSLocalizedString(@"Trophy", nil),NSLocalizedString(@"applause", nil),NSLocalizedString(@"Drumsticks", nil),NSLocalizedString(@"champagne", nil),NSLocalizedString(@"Falsefaceglasses", nil),NSLocalizedString(@"Lips", nil),NSLocalizedString(@"Goldmicrophone", nil),NSLocalizedString(@"Panda", nil),NSLocalizedString(@"Stars", nil),NSLocalizedString(@"Guitar", nil),NSLocalizedString(@"Thechest", nil),NSLocalizedString(@"spider", nil),NSLocalizedString(@"gemstone", nil),NSLocalizedString(@"baby", nil),NSLocalizedString(@"Diamonds", nil),NSLocalizedString(@"Fireworks", nil),NSLocalizedString(@"heart", nil),NSLocalizedString(@"Flower", nil),NSLocalizedString(@"Abunchofflowers", nil),NSLocalizedString(@"Rose", nil),NSLocalizedString(@"Rose", nil),NSLocalizedString(@"Dinner", nil),NSLocalizedString(@"Crystalball", nil),NSLocalizedString(@"Lamborghini", nil),NSLocalizedString(@"UFO", nil),NSLocalizedString(@"Cake", nil),NSLocalizedString(@"Sportscar", nil),NSLocalizedString(@"meteor", nil),NSLocalizedString(@"Mermaid", nil),NSLocalizedString(@"Sportscar", nil),NSLocalizedString(@"Boxingglove", nil),NSLocalizedString(@"rocket", nil),NSLocalizedString(@"Castle", nil),NSLocalizedString(@"Castle", nil),NSLocalizedString(@"Castle", nil)];
