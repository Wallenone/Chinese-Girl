...
@property(nonatomic,strong)MycommitModel *myCommitModel;
...
-(UIImageView *)AvatarImgView{
    if (!_AvatarImgView) {
        ...
        _AvatarImgView.image=[UIImage imageNamed:self.myCommitModel.icon];
...
-(UILabel *)nickName{
    if (!_nickName) {
        ...
        _nickName.text=self.myCommitModel.nickName;
...
-(UILabel *)date{
    if (!_date) {
        ...
        _date.text=self.myCommitModel.date;
...
-(UILabel *)commitLabel{
    if (!_commitLabel) {
        ...
        _commitLabel.text=self.myCommitModel.content;
